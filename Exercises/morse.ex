defmodule Morse do
  ...
  def decode([?- | rest], {:node, char, long, short}, head) do
    decode(rest, long , head)
  end
  def decode([?. | rest], {:node, char, long, short}, head) do
    decode(rest, short, head)
  end
  def decode([?\s | rest], {:node, char, _ , _ }, head) do
    [char | decode(rest, head, head)]
  end
